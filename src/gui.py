...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Sat Jan 23 12:16:53 2021
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_15 = wx.StaticText(self.notebook_1_Checkin, wx.ID_ANY, "&Name: ", style=wx.ALIGN_RIGHT)
        ...
        self.Bind(wx.EVT_TEXT, self.check_in_search_changed, self.check_in_search)
    ...
    def __set_properties(self):
        ...
        self.check_in_search.ShowSearchButton(False)
        self.check_in_search.ShowCancelButton(True)
    ...
    def __do_layout(self):
        ...
        sizer_21.Add(self.label_15, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)
        sizer_21.Add(self.check_in_search, 2, wx.ALL | wx.EXPAND, 3)
        sizer_21.Add((10, 5), 0, 0, 0)
    ...
    def importSession(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'importSession' not implemented!")
        event.Skip()
    ...
    def createForms(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'createForms' not implemented!")
        event.Skip()

    def loadForms(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'loadForms' not implemented!")
        event.Skip()
    ...
    def check_in_search_changed(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'check_in_search_changed' not implemented!")
        event.Skip()
